...
def main():
    ...
    with tab2:
        ...
        if uploaded_file is not None:
            ...
            st.image(img, caption='Hochgeladenes Bild', use_container_width=False, width=700)
            ...
            st.image(converted_img, caption='Verarbeitetes Bild', use_container_width=False, width=700)
            ...
            if st.button("Bild verbessern"):
                ...
                st.image(cleaned_image, caption="Verbessertes Bild", use_container_width=False, width=700)

            files_to_zip = [r'uploads\output_cleaned.png', r'uploads\output_cleaned.dxf']
